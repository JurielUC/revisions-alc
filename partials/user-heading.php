<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="user-home">
                <img src="assets/img/logo.png" alt="logo" />
            </a>
            <a class="navbar-brand brand-logo-mini" href="user-home">
                <img src="assets/img/logo.png" alt="logo" />
            </a>
        </div>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text">Welcome, <span class="text-black fw-bold"><?php echo $row['first_name']; ?> <?php echo $row['last_name']; ?></span></h1>
                <h3 class="welcome-sub-text">Get an appointment!</h3>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        ...
                        <p class="mb-1 mt-3 font-weight-semibold"><?php echo $row['first_name']; ?> <?php echo $row['last_name']; ?></p>
                        <p class="fw-light text-muted mb-0"><?php echo $row['email']; ?></p>
                    </div>
                    <a class="dropdown-item" href="user-profile"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile</a>
