<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="create-result-<?php echo $row1['appointment_id'] ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="triglycerides" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="uric_acid" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="creatinine" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sgpt_alt" required
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label>HDL</label>
                                                        <input type="text" name="hdl" required
                                                    ...
                                                    <div class="form-group">
                                                        <label>LDL</label>
                                                        <input type="text" name="ldl" required
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sgot_ast" required
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Bun</label>
                                                        <input type="text" name="bun" required
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="consistency" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="ph_reaction" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="specific_gravity" required
                                                    ...
                                                    <div class="form-group">
                                                        <label>Sugar</label>
                                                        <input type="text" name="sugar" required
                                                ...
                                                ?>
                                                    <div class="form-group">
                                                        <label>WBC</label>
                                                        <input type="text" name="wbc" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="hematocrit" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="granulocytes" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="platelet" required
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="result_impression" required
                                                        class="form-control <?php echo (!empty($result_impression_err)) ? 'is-invalid' : ''; ?>"
                                                        placeholder="Please enter result impression."
                                                        style="width: 100%; height: 200px; resize: vertical;"><?php echo $result_impression; ?></textarea>
